...
- [x] **Step 3: Implement the two-bit chart state and resolver**
...
- [x] **Step 3: Replace the manifest representation**
...
- [x] **Step 2: Write failing real egui tests**
...
- [x] **Step 4: Implement commands and UI**
...
- [x] **Step 1: Write failing bowl tests**
...
- [x] **Step 3: Enable bowl mirroring and regenerate every package**
...
- [x] **Step 4: Verify assets and rendered evidence**
...
- [x] **Step 1: Search for the displaced representation**
...
- [x] **Step 3: Append conformance evidence**
